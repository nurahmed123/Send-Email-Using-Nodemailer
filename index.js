...
const server = http.createServer((request, response) => {
    ...
    let name = "nur"
    let phone = "+8801888772094"
    let email = "demomail@gmail.com"
    let message = "Hello, This is a test mail from Node Js!"
    let subject = "this is a new subject"
																		...
																		<td class="alignment" style="vertical-align: middle; text-align: center;"><!--[if vml]><table align="center" cellpadding="0" cellspacing="0" role="presentation" style="display:inline-block;padding-left:0px;padding-right:0px;mso-table-lspace: 0pt;mso-table-rspace: 0pt;"><![endif]-->
																			...
																			<table class="icons-inner" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; display: inline-block; margin-right: -4px; padding-left: 0px; padding-right: 0px;" cellpadding="0" cellspacing="0" role="presentation"><!--<![endif]-->
																				<tr>
																					...
																					<td style="font-family: 'Inter', sans-serif; font-size: 15px; font-weight: undefined; color: #1e0e4b; vertical-align: middle; letter-spacing: undefined; text-align: center;"><a href="https://www.linkedin.com/in/06nurahmed/" target="_blank" style="color: #1e0e4b; text-decoration: none;">Designed with Nur Ahmad</a></td>
																				</tr>
																			</table>
																		</td>
																	</tr>
